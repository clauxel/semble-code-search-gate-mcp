...
```text
https://semblecodesearchgate.clauxel.com/mcp
```

## Authentication

Use a bearer token from https://semblecodesearchgate.clauxel.com/?utm_source=github_docs&utm_medium=directory&utm_campaign=sbl202605.
